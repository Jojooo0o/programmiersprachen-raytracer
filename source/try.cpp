...
int main(int argc, char* argv[])
{
  ...
  for(int i=0; i<= 120; i+= 60){
    ...
    new_txt << std::endl;
    new_txt << "define camera cam 50 "<< cammove_x << " " << cammove_y << " " << cammove_z << " " << -cammove_x << " " << -cammove_y << " " << -cammove_z << " " << -cammove_x << " " << 1000 -cammove_y << " " << -cammove_z << std::endl;
    ...
    //new_txt << "define shape box spinbox2 -5 -5 -5 5 5 5  orange" << std::endl;
    new_txt << std::endl;
    ...
    //new_txt << "transform spinbox2 rotate " << rotatesphere << " 1 1 1 " << std::endl;
